...
String _TERRAME_GIT_DIR =          "$_TERRAME_BUILD_BASE/\${ghprbActualCommit}/git";
String _TERRAME_TEST_DIR =         "$_TERRAME_BUILD_BASE/\${ghprbActualCommit}/test"
String _TERRAME_DEPENDS_DIR =      "$_TERRAME_BUILD_BASE/3rdparty/install";
String _TERRAME_OUT_DIR =          "$_TERRAME_BUILD_BASE/\${ghprbActualCommit}/solution/build";
String _TERRAME_INSTALL_PATH =     "$_TERRAME_BUILD_BASE/\${ghprbActualCommit}/solution/install";
